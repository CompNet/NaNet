...
plot.file <- get.path.stats.topo(mode="scenes", char.det="implicit", net.type="static", weights="none", meas.name=MEAS_MULTI_GRAPH, filtered="both", suf=paste0("giant-comp-size_vs_centrality"))
