...
# char.det: character detection mode ("implicit" vs "explicit").
# 
# returns: a sequence of graphs corresponding to a dynamic graph.
###############################################################################
cum.graph.extraction <- function(char.stats, scene.chars, scene.stats, volume.stats, filtered=FALSE, pub.order=TRUE, char.det=NA)
