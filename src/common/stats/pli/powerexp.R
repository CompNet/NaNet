...
# TODO At this point, you need to edit the file "Makefile" to give the location of
...
# files.  TODO Then edit the variable "exp_int_function_filename" in this file,
...
exp_int_function_filename <- "src/common/stats/pli/exponential-integral/exp_int.exe"
