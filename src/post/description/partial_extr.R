# Extracts two separate networks to model to distinct phases of the narrative, 
# in order to produce two distinct graphical reprensentations and highlight changes 
# in the global structureof the interpersonal relationships. That did not produce 
