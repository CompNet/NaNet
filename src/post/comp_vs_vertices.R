...
# plot size results
plot.file <- get.path.comparison.plot(object="nodes", mode="scenes", meas.name="degree", filtered=FALSE, plot.type="comp_size_vs_vertices")
...
# plot count results
plot.file <- get.path.comparison.plot(object="nodes", mode="scenes", meas.name="degree", filtered=FALSE, plot.type="comp_nbr_vs_vertices")
...
# plot size results
plot.file <- get.path.comparison.plot(object="nodes", mode="scenes", meas.name="degree", filtered=TRUE, plot.type="comp_size_vs_vertices")
tlog(4, "Plotting largest component size in file ",plot.file)
ylab <- "Largest component size (proportion of vertices)"
for(fformat in PLOT_FORMAT)
{	if(fformat==PLOT_FORMAT_PDF)
...
# plot count results
plot.file <- get.path.comparison.plot(object="nodes", mode="scenes", meas.name="degree", filtered=TRUE, plot.type="comp_nbr_vs_vertices")
tlog(4, "Plotting component number in file ",plot.file)
ylab <- "Number of components"
for(fformat in PLOT_FORMAT)
{	if(fformat==PLOT_FORMAT_PDF)
...
plot.file <- get.path.comparison.plot(object="nodes", mode="scenes", meas.name="degree", filtered=FALSE, plot.type="comp_vs_vertices_both")
